...
import danggnMarketLogo from '../img/danggn-market-logo2.png';
  ...
  render() {
    ...
    return (
      <div className="w3-display-container w3-container">
        <img src={danggnMarketLogo} alt="danggn-logo" style={logoStyle} />
        <div
          className="w3-display-topright w3-text-black"
          style={logoInfoStyle}
        >
          <br></br>
          <br></br>
